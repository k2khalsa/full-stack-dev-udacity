...
Revision ID: 4b25d75b3ccd
Revises: dc183a29c9ed
Create Date: 2020-05-21 15:01:53.307696
...
revision = '4b25d75b3ccd'
down_revision = 'dc183a29c9ed'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('Artist', 'phone', existing_type=sa.VARCHAR(
    ...
    op.add_column('Venue', sa.Column(
        'website', sa.String(length=120), nullable=True))
    op.alter_column('Venue', 'address', existing_type=sa.VARCHAR(
        length=120), nullable=False)
    op.alter_column('Venue', 'city', existing_type=sa.VARCHAR(
        length=120), nullable=False)
    op.alter_column('Venue', 'name',
                    existing_type=sa.VARCHAR(), nullable=False)
    op.alter_column('Venue', 'phone', existing_type=sa.VARCHAR(
        length=120), nullable=False)
    op.alter_column('Venue', 'state', existing_type=sa.VARCHAR(
        length=120), nullable=False)
